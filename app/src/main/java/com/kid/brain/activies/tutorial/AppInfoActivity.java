...
public class AppInfoActivity extends BaseAppCompatActivity {
    ...
    private static String TAG = AppInfoActivity.class.getName();
    ...
    @AfterViews
    void afterViews() {
        setUpToolbarWithBackButton(toolbar, R.string.str_app_info);
        showFragment(AppInfoFragment_.newInstance());
    }
