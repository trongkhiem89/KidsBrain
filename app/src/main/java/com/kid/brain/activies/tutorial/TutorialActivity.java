...
public class TutorialActivity extends BaseAppCompatActivity {
    ...
    private static String TAG = TutorialActivity.class.getName();
    ...
    @AfterViews
    void afterViews() {
        setUpToolbarWithBackButton(toolbar, R.string.str_tutorial);
        showFragment(TutorialFragment_.newInstance());
    }
